      ...
      <Container>
        <div className="heading-container">
          ...
          <div className="text-container">
            <Text  textColor="#363c50" fontSize={50}>Welcome to the</Text>
            <br />
            <br />
        ...
        <div className="exercise-container">
          <Exercise svgBgColor="#fbf2ea ">
            ...
            <text className="exercise-text">HTML</text>
          </Exercise>
          <Exercise svgBgColor="#e9fdef">
            <div className="svg-container">
            ...
            <text className="exercise-text">CSS</text>
          </Exercise>
          <Exercise svgBgColor="#edeffe">
            <div className="svg-container">
            ...
            <text className="exercise-text">Javascript</text>
          </Exercise>
          <Exercise svgBgColor="#f2e6fe">
            <div className="svg-container">
            ...
            <text className="exercise-text">Accessibility</text>
          </Exercise>
